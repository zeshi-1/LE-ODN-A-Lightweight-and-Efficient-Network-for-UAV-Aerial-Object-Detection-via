...
from ultralytics.nn.Efficient import stem
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,SPPF_SE,
                 ...
                 BSBlock, embedfasternet, mergefasternet,AVCStem,VoVGSCSPC,GSConv,C2f_DySnakeConv,SE,SPDConv,C2f_SCConv,SCDown,SPPF_LSKA,C2f_AKConv
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x,
                     ...
                     C2f_Triplet, C2f_SpatialGroupEnhance, C2f_S2, C2f_NAM,
                     C2f_ParNet, C2f_GAM, C2f_CrissCross, C2f_ParallelPolarized, C2f_SequentialPolarized,
                     AVCStem, VoVGSCSPC,C2f_DySnakeConv,BiLevelRoutingAttention,C2f_SCConv,C2f_AKConv
                     ):
